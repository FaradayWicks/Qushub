                ...
                <div className="swiper-wrapper">
                    ...
                    <div className="row g-md-4 gy-5">
                      <div className="col-md-5 d-flex justify-content-md-center">
                        <div className="author-img magnetic-item">
                          <img src="assets/img/home2/Mr. Daniel Scoot.jpg" alt="" style={{
                            height: "336px",
                            width: "283px",
                            objectFit: "contain"
                          }} />
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="row g-lg-4 gy-5">
                      <div className="col-md-5 d-flex justify-content-md-center">
                        <div className="author-img magnetic-item">
                          <img src="assets/img/home2/Luka Moris.jpg" alt="" style={{
                            height: "336px",
                            width: "283px",
                            objectFit: "contain"
                          }} />
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="row g-lg-4 gy-5">
                      <div className="col-md-5 d-flex justify-content-md-center">
                        <div className="author-img magnetic-item">
                          <img src="assets/img/home2/Flurance Miyagi.jpg" alt="" style={{
                            height: "336px",
                            width: "283px",
                            objectFit: "contain"
                          }} />
