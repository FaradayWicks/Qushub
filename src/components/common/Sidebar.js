    ...
    <div className={`sidebar-area ${isMenuOpen ? 'active' : ''}`}>
      <div className="sidebar-menu-top-area">
        <div className="sidebar-menu-logo">
          <Link className="logo-dark" href="/"><img alt="Quishub mark" className="img-fluid" src="/assets/img/quishub-mark-transparent.png" /></Link>
          <Link className="logo-light" href="/"><img alt="Quishub mark" className="img-fluid" src="/assets/img/quishub-mark-transparent.png" /></Link>
        </div>
