    ...
    return (
      <motion.button
        ...
        className={cn(
          ...
          variant === "primary" &&
            "text-[var(--button-primary-fg)] [background:var(--button-primary-bg)] hover:opacity-95 shadow-[0_8px_24px_-10px_rgba(124,58,237,0.6),0_8px_24px_-10px_rgba(37,99,235,0.6)] dark:shadow-none",
          variant === "secondary" &&
