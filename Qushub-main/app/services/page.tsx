          ...
          >
            <div className="container-content">
              ...
              >
                ...
                >
                  <div className="surface-icon flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-[10px]">
                    <Icon
                      size={22}
                      className="text-quishub-black"
                    />
                  </div>
                  <h2
                    className="font-semibold tracking-heading text-quishub-black"
            ...
            {processSteps.map((step) => {
              ...
              return (
                <motion.div
                  ...
                  variants={fadeUp}
                  transition={{ duration: 0.5, ease: "easeOut" }}
                  className="surface-card relative rounded-card p-7"
                >
                  <span className="surface-number absolute right-5 top-4 select-none text-4xl font-bold">
                    {step.num}
                  </span>
                  <div className="surface-icon flex h-10 w-10 items-center justify-center rounded-full">
                    <StepIcon size={18} className="text-quishub-black" />
                  </div>
