          ...
          {services.map((service) => {
            ...
            return (
              <motion.article
                key={service.title}
                variants={fadeUp}
                className="surface-card rounded-card p-7 transition-transform duration-200 cursor-pointer hover:scale-[1.01]"
              >
                ...
                <h3 className="mt-4 text-[17px] font-semibold text-quishub-black">
                  {service.title}
                </h3>
